...
nouns = ['Chair', 'Laptop', 'Book', 'City', 'New York', 'Banana',  'Family', 'Ice cream', 'Table', 'Anger' 'mouse',
         'cat']
adjectives = ['Blue', 'Red', 'Purple', 'Green', 'Black', 'Cyan', 'Rainbow', 'Marin', 'Mink', 'Orange', 'perfect',
              'sharp']
punctuations = ['!', '@', '#', '$', '%', '^', '&', '*', '(', ')', '~', '`']
